...
},{"./_root":32}],19:[function(require,module,exports){
/**
...
},{"./_arrayPush":20,"./_isFlattenable":29}],22:[function(require,module,exports){
...
},{"./_Symbol":18,"./_getRawTag":28,"./_objectToString":31}],23:[function(require,module,exports){
...
},{"./_baseGetTag":22,"./isObjectLike":37}],24:[function(require,module,exports){
var baseGetTag = require('./_baseGetTag'),
    isObjectLike = require('./isObjectLike');
...
},{"./_baseGetTag":22,"./isObjectLike":37}],25:[function(require,module,exports){
var Symbol = require('./_Symbol'),
...
},{"./_Symbol":18,"./_arrayMap":19,"./isArray":36,"./isSymbol":40}],26:[function(require,module,exports){
/**
...
},{"./_Symbol":18}],29:[function(require,module,exports){
var Symbol = require('./_Symbol'),
...
},{"./_Symbol":18,"./isArguments":35,"./isArray":36}],30:[function(require,module,exports){
...
},{"./_freeGlobal":27}],31:[function(require,module,exports){
/** Used for built-in method references. */
var objectProto = Object.prototype;
...
},{"./toString":41}],34:[function(require,module,exports){
...
},{"./_baseFlatten":21}],35:[function(require,module,exports){
...
},{"./_baseIsArguments":23,"./isObjectLike":37}],36:[function(require,module,exports){
/**
...
},{"./_baseIsRegExp":24,"./_baseUnary":26,"./_nodeUtil":30}],39:[function(require,module,exports){
var baseGetTag = require('./_baseGetTag'),
    isArray = require('./isArray'),
    isObjectLike = require('./isObjectLike');
...
},{"./_baseGetTag":22,"./isArray":36,"./isObjectLike":37}],40:[function(require,module,exports){
var baseGetTag = require('./_baseGetTag'),
    isObjectLike = require('./isObjectLike');
...
},{"./_baseGetTag":22,"./isObjectLike":37}],41:[function(require,module,exports){
...
},{"./_baseToString":25}],42:[function(require,module,exports){
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
},{"./lib/ReactPropTypesSecret":44,"_process":1,"fbjs/lib/invariant":13,"fbjs/lib/warning":17}],44:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/EventListener":2,"fbjs/lib/ExecutionEnvironment":3,"fbjs/lib/containsNode":6,"fbjs/lib/emptyFunction":7,"fbjs/lib/emptyObject":8,"fbjs/lib/focusNode":9,"fbjs/lib/getActiveElement":10,"fbjs/lib/shallowEqual":16,"object-assign":42,"react":51}],47:[function(require,module,exports){
(function (process){
'use strict';
...
},{"lodash/escapeRegExp":33,"lodash/flatten":34,"lodash/isRegExp":38,"lodash/isString":39}],49:[function(require,module,exports){
(function (process){
/** @license React v16.1.1
...
},{"_process":1,"fbjs/lib/emptyFunction":7,"fbjs/lib/emptyObject":8,"fbjs/lib/invariant":13,"fbjs/lib/warning":17,"object-assign":42,"prop-types/checkPropTypes":43}],50:[function(require,module,exports){
/** @license React v16.1.1
...
},{"fbjs/lib/emptyFunction":7,"fbjs/lib/emptyObject":8,"object-assign":42}],51:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./cjs/react.development.js":49,"./cjs/react.production.min.js":50,"_process":1}],52:[function(require,module,exports){
"use strict";
...
var _renderelement = require("./renderelement.jsx");
...
var Converter = function (_React$Component) {
    ...
    function Converter(props) {
        ...
        return _possibleConstructorReturn(this, (Converter.__proto__ || Object.getPrototypeOf(Converter)).call(this, props));
    }
    ...
    _createClass(Converter, [{
        ...
        value: function render() {
            ...
            if (this.props.content.hasOwnProperty('blocks')) {
                ...
                var currentList = "",
                    previousType = "";
                blocks.forEach(function (block, bKey) {
                    ...
                    if (block.type == "unordered-list-item" || block.type == "ordered-list-item") {
                        ...
                        if ((previousType != block.type || previousType == "") && currentList == "") {
                            currentList = new _list2.default();
                        ...
                        elem = _react2.default.createElement(_renderelement2.default, { elemkey: block.key, text: block.text, type: block.type, inlineStyleRanges: block.inlineStyleRanges, entityRanges: block.entityRanges, entityMap: _this2.props.content.entityMap });
                    }
            ...
            return _react2.default.createElement(
                "article",
                { key: "article-" + this.props.elemkey },
                toRender
            );
        }
    }]);
...
},{"./list.jsx":54,"./renderelement.jsx":55,"react":51}],53:[function(require,module,exports){
"use strict";
...
var Mention = function (_React$Component) {
    ...
    function Mention(props) {
        ...
        return _possibleConstructorReturn(this, (Mention.__proto__ || Object.getPrototypeOf(Mention)).call(this, props));
    }
    ...
    _createClass(Mention, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                "span",
                { className: "tooltips highlight red" },
                this.props.text,
                _react2.default.createElement(
                    "div",
                    null,
                    _react2.default.createElement("img", { src: this.props.data.img.originalFileName, alt: this.props.data.text }),
                    _react2.default.createElement(
                        "label",
                        { htmlFor: "user" },
...
var Link = function (_React$Component2) {
    ...
    _createClass(Link, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                "a",
                { href: this.props.data.url, title: this.props.data.description, target: "_blank" },
                this.props.text
            );
        }
    }]);
...
var Entity = function (_React$Component3) {
...
module.exports = { Mention: Mention, Link: Link, Entity: Entity };

},{"react":51}],54:[function(require,module,exports){
"use strict";
    ...
    _createClass(List, [{
        ...
        value: function produce() {
            ...
            this.list.forEach(function (item) {
                var elem = _react2.default.createElement(_renderelement2.default, { elemkey: item.key, text: item.text, type: item.type, inlineStyleRanges: item.inlineStyleRanges });
                uniqueKey.push(item.key);
                listElem.push(elem);
            });
            return this.list[0].type == "unordered-list-item" ? _react2.default.createElement(
                "ul",
                { key: uniqueKey.join("|") },
                listElem
            ) : _react2.default.createElement(
...
},{"./renderelement.jsx":55,"react":51}],55:[function(require,module,exports){
"use strict";
...
var _entities = require("./entities.jsx");
 ...
 * @extends {React.Component}
 */
var RenderElement = function (_React$Component) {
    _inherits(RenderElement, _React$Component);

    function RenderElement(props) {
        _classCallCheck(this, RenderElement);

        return _possibleConstructorReturn(this, (RenderElement.__proto__ || Object.getPrototypeOf(RenderElement)).call(this, props));
    }
    ...
    _createClass(RenderElement, [{
        ...
        value: function render() {
            ...
            if (this.props.hasOwnProperty('entityRanges') && this.props.entityRanges.length > 0 && _typeof(this.props.hasOwnProperty('entityMap'))) {
                var textEntityPool = [];
                this.props.entityRanges.forEach(function (entity) {
                    var entityString = text.substr(entity.offset, entity.length);
                    textEntityPool.push({
                        value: entityString,
                        key: entity.key,
                        type: _this2.props.entityMap[entity.key].type
                    });
                });

                textEntityPool.forEach(function (textEntity, tKey) {
                    var pattern = new RegExp("(" + textEntity.value + ")", 'gi');
                    text = (0, _reactStringReplace2.default)(text, pattern, function (match, i) {
                        switch (textEntity.type) {
                            case 'MENTION':
                                return _react2.default.createElement(_entities.Mention, { key: "entity" + tKey + i, text: match, data: _this2.props.entityMap[textEntity.key].data });
                                break;
                            case 'LINK':
                                return _react2.default.createElement(_entities.Link, { key: "entity" + tKey + i, text: match, data: _this2.props.entityMap[textEntity.key].data });
                                break;
                            default:
                                return _react2.default.createElement(_entities.Entity, { key: "entity" + tKey + i, text: match, data: _this2.props.entityMap[textEntity.key].data });
                                break;
                        }
                    });
                });
            ...
            if (this.props.inlineStyleRanges.length > 0) {
                ...
                this.props.inlineStyleRanges.forEach(function (inlineStyle) {
                ...
                stylizedTextPool.forEach(function (stylizedString, sKey) {
...
},{"./entities.jsx":53,"react":51,"react-string-replace":48}],56:[function(require,module,exports){
"use strict";
...
_reactDom2.default.render(_react2.default.createElement(_app2.default, { elemkey: "article-" + new Date().valueOf(), content: task1 }), document.querySelector('#container #task1'));

_reactDom2.default.render(_react2.default.createElement(_app2.default, { elemkey: "article-" + new Date().valueOf(), content: task2 }), document.querySelector('#container #task2'));

_reactDom2.default.render(_react2.default.createElement(_app2.default, { elemkey: "article-" + new Date().valueOf(), content: task3 }), document.querySelector('#container #task3'));

},{"../../src/app.jsx":52,"react":51,"react-dom":47}]},{},[56]);
